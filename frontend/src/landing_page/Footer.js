...
function Footer() {
  return (
    <div className=" border-top" style={{backgroundColor: "#f8f9fa"}}>
    <div className="container  p-1" >
      <div className="row mt-5">
        <div className="col">
          <img className="mb-3" src="media/images/logo.svg" style={{ width: "50%" }}></img>
        ...
        <div className="col">
          ...
          <a className="mb-3" style={{textDecoration:"none"}} href="">Contact us</a>
          <br />
